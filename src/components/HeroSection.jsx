    ...
    <div className="min-h-screen flex items-center justify-center flex-col py-20">
      <div className="text-center flex-grow">
        ...
        <div className="w-full h-full relative overflow-hidden text-black dark:text-gray-200 left-0 mt-5">
          <motion.div initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="font-interTight font-bold text-9xl leading-12 text-center whitespace-normal" style={{ letterSpacing: '-1px' }}>
        ...
        <motion.div
          ...
          className="font-interTight font-bold text-9xl mb-5 leading-12 text-center whitespace-normal dark:text-gray-200"
        ...
        <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.5, duration: 1 }} className="flex items-center justify-center flex-col ">
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 2, duration: 1 }} className="text-center text-2xl text-black dark:text-gray-200 ">
