    ...
    <div>
      <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.5, duration: 1 }} className="flex items-center justify-center flex-col ">
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 2, duration: 1 }} className="text-center text-lg md:text-xl text-black dark:text-gray-200 ">
          ...
          <img src="/src/assets/closeup.png " width="70" height="70"></img>
          <p className="text-left w-3/4 my-5">
            She's a&nbsp;
          ...
          <ul className="flex">
            <li className="mr-6">
              <a href="https://mastodon.social/@dizzyup" rel="me" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="-1 -1 28 28" className="text-blue-500 hover:text-violet-500">
                  <path
                    fill="currentColor"
                    fillRule="evenodd"
